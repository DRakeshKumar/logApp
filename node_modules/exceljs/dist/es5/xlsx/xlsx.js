...
XLSX.prototype = {
  ...
  processWorksheetEntry: function processWorksheetEntry(entry, model) {
  ...
  createInputStream: function createInputStream() {
    var self = this;
    var model = {
      worksheets: [],
      worksheetHash: {},
    ...
    stream.on('entry', function (entry) {
      ...
      switch (entryPath) {
        ...
        default:
          promise = self.processWorksheetEntry(entry, model) || self.processWorksheetRelsEntry(entry, model) || self.processThemeEntry(entry, model) || self.processMediaEntry(entry, model) || self.processDrawingEntry(entry, model) || self.processDrawingRelsEntry(entry, model) || self.processIgnoreEntry(entry);
          break;
      }
